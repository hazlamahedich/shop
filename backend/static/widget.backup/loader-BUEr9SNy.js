  ...
  const {
    ...
    () => ({
      createSession: async (visitorId) => {
        const { widgetClient } = await import("./widgetClient-CGSAA0Tw.js");
...
Your cart now has ${updatedCart.itemCount} ${itemWord} totaling $${updatedCart.total.toFixed(2)}.`,
  ...
  reactExports.useEffect(() => {
    ...
    const connectWebSocket = async () => {
      const { connectWidgetWebSocket, isWebSocketSupported } = await import("./widgetWsClient-DONcmbG9.js");
...
const ChatWindow$2 = reactExports.lazy(() => import("./ChatWindow-DAmLlCTo.js"));
