...
function WidgetProvider({ children, merchantId }) {
  ...
  const {
    ...
    () => ({
      createSession: async () => {
        const { widgetClient } = await import("./widgetClient-DjEWipWp.js");
  ...
  }, [initWidget2, sendMessage, addToCart, checkout]);
...
const ChatWindow$2 = reactExports.lazy(() => import("./ChatWindow-XIPcF6s7.js"));
