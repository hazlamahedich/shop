...
Your cart now has ${updatedCart.itemCount} ${itemWord} totaling $${updatedCart.total.toFixed(2)}.`,
  ...
  reactExports.useEffect(() => {
    ...
    const connectSSE = async () => {
      const { connectToWidgetSSE, isSSESupported } = await import("./widgetSSEClient-CeeBF1nj.js");
...
const ChatWindow$2 = reactExports.lazy(() => import("./ChatWindow-Dx3B7aA3.js"));
