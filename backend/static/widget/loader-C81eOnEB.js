...
Your cart now has ${updatedCart.itemCount} ${itemWord} totaling $${updatedCart.total.toFixed(2)}.`,
  ...
  reactExports.useEffect(() => {
    ...
    const connectSSE = async () => {
      const { connectToWidgetSSE, isSSESupported } = await import("./widgetSSEClient-vgjNXkSG.js");
...
const ChatWindow$2 = reactExports.lazy(() => import("./ChatWindow-D7eId4-y.js"));
