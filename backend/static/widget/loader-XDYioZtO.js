...
function isOnShopify() {
  ...
  const result = hostname.includes("myshopify.com") || ((_b = (_a = shopifyWindow.Shopify) == null ? void 0 : _a.routes) == null ? void 0 : _b.root) !== void 0 || ((_c = shopifyWindow.Shopify) == null ? void 0 : _c.shop) !== void 0;
...
function refreshCartUI() {
  ...
  if (typeof ((_a = shopifyWindow.Shopify) == null ? void 0 : _a.onCartUpdate) === "function") {
    try {
...
function WidgetProvider({ children, merchantId }) {
  ...
  const {
    ...
    () => ({
      createSession: async () => {
        const { widgetClient } = await import("./widgetClient-sG1lk9_A.js");
...
Your cart now has ${updatedCart.itemCount} ${itemWord} totaling $${updatedCart.total.toFixed(2)}.`,
  ...
  const checkout = reactExports.useCallback(async () => {
    ...
    try {
      const shopDomain = (_a2 = state.config) == null ? void 0 : _a2.shopDomain;
      if (!shopDomain) {
  ...
  reactExports.useEffect(() => {
    ...
    const connectSSE = async () => {
      const { connectToWidgetSSE, isSSESupported } = await import("./widgetSSEClient-BJIWSV9K.js");
      if (!isSSESupported()) return;
      cleanup = connectToWidgetSSE(state.session.sessionId, {
        onMessage: (event) => {
          if (event.type === "merchant_message") {
            const data = event.data;
            console.log("[Widget] Received merchant message via SSE:", data.content);
...
class WidgetErrorBoundary extends reactExports.Component {
  constructor() {
    ...
    __publicField(this, "handleRetry", () => {
      ...
      (_b = (_a = this.props).onRetry) == null ? void 0 : _b.call(_a);
    });
  ...
  render() {
    ...
    if (this.state.hasError) {
      ...
      const isChunkError = ((_a = error == null ? void 0 : error.message) == null ? void 0 : _a.includes("ChunkLoadError")) || ((_b = error == null ? void 0 : error.message) == null ? void 0 : _b.includes("Loading chunk"));
...
const ChatWindow$2 = reactExports.lazy(() => import("./ChatWindow-BSVQD60U.js"));
...
function getConfig() {
  var _a, _b;
  if ((_a = window.ShopBotConfig) == null ? void 0 : _a.merchantId) {
...
function initWidget() {
  ...
  if (!(config == null ? void 0 : config.merchantId)) {
    console.error(
