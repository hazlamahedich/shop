...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_llm_conversation_costs_conversation_id", "llm_conversation_costs", ["conversation_id"]
    )
    op.create_index(
        "ix_llm_conversation_costs_merchant_id", "llm_conversation_costs", ["merchant_id"]
    )
    op.create_index("ix_llm_conversation_costs_provider", "llm_conversation_costs", ["provider"])
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_llm_conversation_costs_request_timestamp", table_name="llm_conversation_costs"
    )
