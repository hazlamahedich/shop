...
class CheckoutResult(BaseModel):
    ...
    checkout_url: str | None = Field(None, description="Generated checkout URL")
    checkout_token: str | None = Field(None, description="Checkout token for order confirmation")
