...
class ErrorCode(IntEnum):
    ...
    UNAUTHORIZED = 2003
    AUTH_SESSION_REVOKED = 2011  # Session revoked or not found
    ...
    # Story 6-3: Merchant data export (GDPR compliance)
    EXPORT_RATE_LIMITED = 11010
    EXPORT_ALREADY_IN_PROGRESS = 11011
    ...
    WIDGET_RATE_LIMITED = 12003
    WIDGET_MERCHANT_DISABLED = 12004
    WIDGET_INVALID_CONFIG = 12005
    WIDGET_DOMAIN_NOT_ALLOWED = 12006
    WIDGET_MESSAGE_TOO_LONG = 12007
    # Story 5.6: Widget Settings (12010-12019)
    WIDGET_SETTINGS_INVALID_COLOR = 12010
    WIDGET_SETTINGS_INVALID_POSITION = 12011
    WIDGET_SETTINGS_SAVE_FAILED = 12012
    WIDGET_SETTINGS_NOT_FOUND = 12013
    # Story 5-10: Widget Full App Integration (12020-12029)
    WIDGET_CART_EMPTY = 12020
    WIDGET_NO_SHOPIFY = 12021
    WIDGET_CHECKOUT_FAILED = 12022
    WIDGET_SEARCH_FAILED = 12023
