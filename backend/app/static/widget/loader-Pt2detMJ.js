...
Your cart now has ${updatedCart.itemCount} ${itemWord} totaling $${updatedCart.total.toFixed(2)}.`,
  ...
  reactExports.useEffect(() => {
    ...
    const connectWebSocket = async () => {
      const { connectWidgetWebSocket, isWebSocketSupported } = await import("./widgetWsClient-Cn5JXq0o.js");
...
const ChatWindow$2 = reactExports.lazy(() => import("./ChatWindow-EGEtgfAN.js"));
