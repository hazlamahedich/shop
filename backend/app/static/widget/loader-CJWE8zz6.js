...
Your cart now has ${updatedCart.itemCount} ${itemWord} totaling $${updatedCart.total.toFixed(2)}.`,
  ...
  reactExports.useEffect(() => {
    ...
    const connectWebSocket = async () => {
      const { connectWidgetWebSocket, isWebSocketSupported } = await import("./widgetWsClient-BZxEqbH6.js");
...
const ChatWindow$2 = reactExports.lazy(() => import("./ChatWindow-Dr-4ShK-.js"));
